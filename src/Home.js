        ...
        <div className="home">
            <div className="home__container">
                ...
                <div className="home__row">
                    ...
                    <Product title="How to Use The Laws of Mind"
                        price={30.00 }
                ...
                <div className="home__row">
                    <Product title="ASUS TUF Gaming A15 (2021) 15.6-inch (39.62 cms)"
                        price={1100}
